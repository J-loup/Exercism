public class WeatherStation
{
    ...
    public Outlook ShortTermOutlook
    {
        get
        {
            ...
            if (reading.Pressure < 10m && reading.Temperature < 30m) return Outlook.Cool;
    ...
    public Outlook LongTermOutlook
    {
        get
        {
            ...
            {
                case WindDirection.Easterly when reading.Temperature <= 20: return Outlook.Warm;
                case WindDirection.Easterly when reading.Temperature > 20: goto case WindDirection.Southerly; // Fallthrough
                case WindDirection.Southerly: return Outlook.Good;
                case WindDirection.Northerly: return Outlook.Cool;
                case WindDirection.Westerly: return Outlook.Rainy;
